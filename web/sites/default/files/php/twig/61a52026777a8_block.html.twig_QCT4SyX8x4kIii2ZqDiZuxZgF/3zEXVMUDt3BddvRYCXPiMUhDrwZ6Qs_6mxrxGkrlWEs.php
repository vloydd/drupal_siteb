...
class __TwigTemplate_734b6465f63687f7febc7c1d3498c650ce11d1a4f6b89469f4611bacadc558e7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<section{{ attributes.addClass(classes) }}>
  ...
  {% if label %}
{#    <hr>#}
    <span{{ title_attributes.addClass(title) }}>{{ label }}</span>
  {% endif %}
  {{ title_suffix }}
  </div>
<div class=\"section\">
...
", "themes/custom/exam/templates/block/block.html.twig", "/var/www/web/themes/custom/exam/templates/block/block.html.twig");
    }
